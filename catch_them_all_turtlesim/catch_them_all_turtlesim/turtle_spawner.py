...
class TurtleSpawnerNode(Node):
    def __init__(self):
        ...
        self.declare_parameter("interval_of_spawning_new_turtle",0.8)
        ...
        self.spawn_turtle_timer_ = self.create_timer(self.get_parameter("interval_of_spawning_new_turtle").value, self.spawn_new_turtle)
